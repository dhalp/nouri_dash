...
export const PICTURE_GENERATION_PROMPT = `Make Instagram worthy, photo-realistic, simple pic of the food on a plain white plate with the background color visible.  Show only what is described or provided and absolutely nothing extra. If the plate is <10% pause food make background green. If 10-50% pause food yellow / orange background. If >50% pause food light red pink background. For the title follow title I give you exactly. If I don’t give you title use 2-4 words to describe it. Always make the size of the pictures a rectangle shape ratio 4:5 (width to height).`;
